...
static unsigned char *fix_key_length(const unsigned char *key, xxtea_long key_len)
{
...
static unsigned char *do_xxtea_encrypt(const unsigned char *data, xxtea_long len, const unsigned char *key, xxtea_long *ret_len) {
    unsigned char *result;
...
static unsigned char *do_xxtea_decrypt(const unsigned char *data, xxtea_long len, const unsigned char *key, xxtea_long *ret_len) {
    unsigned char *result;
    xxtea_long *v, *k, v_len, k_len;
...
unsigned char *xxtea_encrypt(const unsigned char *data, xxtea_long data_len, const unsigned char *key, xxtea_long key_len, xxtea_long *ret_length)
{
    unsigned char *result;
...
unsigned char *xxtea_decrypt(const unsigned char *data, xxtea_long data_len, const unsigned char *key, xxtea_long key_len, xxtea_long *ret_length)
{
    unsigned char *result;
