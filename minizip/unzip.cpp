...
int unzReadCurrentFile(unzFile file, voidp buf, uint32_t len)
{
    unz64_internal *s = NULL;
    uint32_t read = 0;
    int err = UNZ_OK;
...
int unzGetLocalExtrafield(unzFile file, voidp buf, uint32_t len)
{
    unz64_internal *s = NULL;
...
int unzGoToFirstFile2(unzFile file, unz_file_info64 *pfile_info, char *filename,
    uint16_t filename_size, void *extrafield, uint16_t extrafield_size, char *comment, uint16_t comment_size)
{
    unz64_internal *s = NULL;
    int err = UNZ_OK;
...
int unzGoToNextFile2(unzFile file, unz_file_info64 *pfile_info, char *filename,
    uint16_t filename_size, void *extrafield, uint16_t extrafield_size, char *comment, uint16_t comment_size)
{
    unz64_internal *s = NULL;
    int err = UNZ_OK;
...
int unzSeek(unzFile file, uint32_t offset, int origin)
{
    return unzSeek64(file, offset, origin);
}

int unzSeek64(unzFile file, uint64_t offset, int origin)
{
    unz64_internal *s = NULL;
