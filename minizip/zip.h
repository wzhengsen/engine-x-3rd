...
#define APPEND_STATUS_ADDINZIP      (2)
    ...
    zipFile CC_DLL zipOpen(const char* path, int append);
    zipFile CC_DLL zipOpen64(const void* path, int append);
    /* Create a zipfile.
    ...
    zipFile CC_DLL zipOpen2(const char* path, int append, const char** globalcomment,
        zlib_filefunc_def* pzlib_filefunc_def);

    zipFile CC_DLL zipOpen2_64(const void* path, int append, const char** globalcomment,
        zlib_filefunc64_def* pzlib_filefunc_def);

    zipFile CC_DLL zipOpen3(const char* path, int append, uint64_t disk_size,
    ...
    zipFile CC_DLL zipOpen3_64(const void* path, int append, uint64_t disk_size,
        const char** globalcomment, zlib_filefunc64_def* pzlib_filefunc_def);

    int CC_DLL zipOpenNewFileInZip(zipFile file, const char* filename, const zip_fileinfo* zipfi,
    ...
    int CC_DLL zipOpenNewFileInZip64(zipFile file, const char* filename, const zip_fileinfo* zipfi,
        const void* extrafield_local, uint16_t size_extrafield_local, const void* extrafield_global,
    ...
    int CC_DLL zipOpenNewFileInZip2(zipFile file, const char* filename, const zip_fileinfo* zipfi,
        const void* extrafield_local, uint16_t size_extrafield_local, const void* extrafield_global,
    ...
    int CC_DLL zipOpenNewFileInZip2_64(zipFile file, const char* filename, const zip_fileinfo* zipfi,
        const void* extrafield_local, uint16_t size_extrafield_local, const void* extrafield_global,
    ...
    int CC_DLL zipOpenNewFileInZip3(zipFile file, const char* filename, const zip_fileinfo* zipfi,
        const void* extrafield_local, uint16_t size_extrafield_local, const void* extrafield_global,
    ...
    int CC_DLL zipOpenNewFileInZip3_64(zipFile file, const char* filename, const zip_fileinfo* zipfi,
        const void* extrafield_local, uint16_t size_extrafield_local, const void* extrafield_global,
        uint16_t size_extrafield_global, const char* comment, uint16_t method, int level, int raw, int windowBits, int memLevel,
        int strategy, const char* password, ZIP_UNUSED uint32_t crc_for_crypting, int zip64);
    /* Same as zipOpenNewFileInZip3 with zip64 support */

    int CC_DLL zipOpenNewFileInZip4(zipFile file, const char* filename, const zip_fileinfo* zipfi,
        const void* extrafield_local, uint16_t size_extrafield_local, const void* extrafield_global,
        uint16_t size_extrafield_global, const char* comment, uint16_t method, int level, int raw, int windowBits, int memLevel,
    ...
    int CC_DLL zipOpenNewFileInZip4_64(zipFile file, const char* filename, const zip_fileinfo* zipfi,
        const void* extrafield_local, uint16_t size_extrafield_local, const void* extrafield_global,
        uint16_t size_extrafield_global, const char* comment, uint16_t method, int level, int raw, int windowBits, int memLevel,
    ...
    int CC_DLL zipOpenNewFileInZip5(zipFile file,
        const char* filename,
    ...
    int CC_DLL zipWriteInFileInZip(zipFile file, const void* buf, uint32_t len);
    /* Write data in the zipfile */

    int CC_DLL zipCloseFileInZip(zipFile file);
    /* Close the current file in the zipfile */

    int CC_DLL zipCloseFileInZipRaw(zipFile file, uint32_t uncompressed_size, uint32_t crc32);
    int CC_DLL zipCloseFileInZipRaw64(zipFile file, uint64_t uncompressed_size, uint32_t crc32);
    ...
    int CC_DLL zipClose(zipFile file, const char* global_comment);
    /* Close the zipfile */

    int CC_DLL zipClose_64(zipFile file, const char* global_comment);

    int CC_DLL zipClose2_64(zipFile file, const char* global_comment, uint16_t version_madeby);
